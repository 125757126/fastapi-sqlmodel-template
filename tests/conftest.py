...
# WARNING: Ensure imports from `fastapi_sqlmodel_template` comes after this line
from fastapi_sqlmodel_template import app, settings, db  # noqa
from fastapi_sqlmodel_template.cli import create_user, cli  # noqa
