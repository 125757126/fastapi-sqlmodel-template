...
├── fastapi_sqlmodel_template             # The main python package for the project
...
e.g: `cat fastapi_sqlmodel_template/VERSION` will get the project version without harming
